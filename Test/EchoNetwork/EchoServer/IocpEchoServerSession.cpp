...
//***************************************************************************
// IocpEchoServerSession.cpp : implementation of the CIocpEchoServerSession class.
//
//***************************************************************************
...
int32 CIocpEchoServerSession::OnRecv(BYTE* buffer, int32 len)
{
    ...
    LOG_WRITE(ELOG_TYPE::LOG_TYPE_INFO, false, _T("[IOCP Session ID(%llu) Received] %s (Len: %d)"), sessionId, receivedStr.c_str(), len);
