...
#ifndef UC_BASEDEFINE_H
#define UC_BASEDEFINE_H
...
#define DATABASE_TEXT_MAX							65535

#define MYSQL_MAX_MESSAGE_LENGTH					512
#define MYSQL_DEFAULT_CONNECTION_TIMEOUT			5
#define MYSQL_DEFAULT_QUERY_READ_TIMEOUT			5
#define MYSQL_DEFAULT_QUERY_WRITE_TIMEOUT			5
