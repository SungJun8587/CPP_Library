...
//***************************************************************************
// @brief 테이블 생성(CREATE TABLE) DDL 쿼리를 생성합니다.
// @return 생성된 CREATE TABLE 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 테이블의 콜레이션 및 스토리지 엔진 변경 DDL 쿼리를 생성합니다.
// @return 생성된 ALTER TABLE 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 테이블 삭제(DROP TABLE) DDL 쿼리를 생성합니다.
// @return 생성된 DROP TABLE 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 테이블명 변경 DDL 쿼리를 생성합니다.
// @param chgTableName 변경할 새 테이블 이름
// @return 생성된 테이블명 변경 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 테이블 내에서 해당 이름을 가진 컬럼 참조 객체를 검색합니다.
// @param columnName 찾고자 하는 컬럼 이름
// @return 검색된 컬럼 참조 객체 (미발견 시 nullptr)
//***************************************************************************
...
//***************************************************************************
// @brief 컬럼 추가(ADD COLUMN) DDL 쿼리를 생성합니다.
// @return 생성된 ADD COLUMN 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 컬럼 변경(ALTER/MODIFY COLUMN) DDL 쿼리를 생성합니다.
// @return 생성된 ALTER/MODIFY COLUMN 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 컬럼 삭제(DROP COLUMN) DDL 쿼리를 생성합니다.
// @return 생성된 DROP COLUMN 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 컬럼명 변경 DDL 쿼리를 생성합니다.
// @param chgColumnName 변경할 새 컬럼 이름
// @return 생성된 컬럼명 변경 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 테이블 정의 구문 내에 들어갈 컬럼 명세 텍스트를 생성합니다.
// @return 생성된 컬럼 명세 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 인덱스 컬럼의 정렬 방향 문자열(ASC/DESC)을 구합니다.
// @return 정렬 방향 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 고유한 인덱스 이름을 자동 생성합니다.
// @return 생성된 인덱스 이름 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 인덱스 생성(CREATE INDEX) DDL 쿼리를 생성합니다.
// @return 생성된 CREATE INDEX 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 인덱스 삭제(DROP INDEX) DDL 쿼리를 생성합니다.
// @return 생성된 DROP INDEX 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 설정된 타입 문자열을 기반으로 인덱스 종휴(EIndexKind)를 구합니다.
// @return 인덱스 종류 (EIndexKind)
//***************************************************************************
...
//***************************************************************************
// @brief 인덱스의 키 유형 키워드(PRIMARY KEY/UNIQUE 등) 문자열을 구합니다.
// @return 키 유형 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 인덱스명 변경 DDL 쿼리를 생성합니다.
// @param chgIndexName 변경할 새 인덱스 이름
// @return 생성된 인덱스명 변경 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 인덱스 구성 컬럼 목록 텍스트를 생성합니다.
// @param isOrderBy 정렬 방향 포함 여부
// @return 생성된 인덱스 컬럼 목록 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 특정 컬럼이 해당 인덱스 구성에 포함되어 있는지 확인합니다.
// @param columnName 검사할 컬럼 이름
// @return 인덱스 포함 여부 (true/false)
//***************************************************************************
...
//***************************************************************************
// @brief 외래키 생성(ADD FOREIGN KEY) DDL 쿼리를 생성합니다.
// @return 생성된 ADD FOREIGN KEY 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 외래키 제약조건 변경 DDL 쿼리(삭제 후 재생성)를 생성합니다.
// @return 생성된 외래키 변경 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 외래키 체크 제약조건 사용 여부 설정 DDL 쿼리를 생성합니다.
// @return 생성된 외래키 체크 설정 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 외래키 삭제(DROP FOREIGN KEY) DDL 쿼리를 생성합니다.
// @return 생성된 DROP FOREIGN KEY 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 고유한 외래키 이름을 자동 생성합니다.
// @return 생성된 외래키 이름 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 외래키 구성 컬럼 목록 텍스트를 생성합니다.
// @param columns 컬럼 참조 벡터
// @return 생성된 컬럼 목록 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 기본값 제약조건 생성 DDL 쿼리를 생성합니다.
// @return 생성된 기본값 제약조건 생성 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 기본값 제약조건 삭제 DDL 쿼리를 생성합니다.
// @return 생성된 기본값 제약조건 삭제 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 체크 제약조건 생성 DDL 쿼리를 생성합니다.
// @return 생성된 체크 제약조건 생성 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 체크 제약조건 삭제 DDL 쿼리를 생성합니다.
// @return 생성된 체크 제약조건 삭제 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 프로시저 생성 DDL 쿼리를 반환합니다.
// @return 생성된 프로시저 DDL 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 프로시저 삭제(DROP PROCEDURE) DDL 쿼리를 생성합니다.
// @return 생성된 DROP PROCEDURE 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 함수 생성 DDL 쿼리를 반환합니다.
// @return 생성된 함수 DDL 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 함수 삭제(DROP FUNCTION) DDL 쿼리를 생성합니다.
// @return 생성된 DROP FUNCTION 쿼리 문자열
//***************************************************************************
...
//***************************************************************************
// @brief 입력 문자열에서 공백 문자를 제거합니다.
// @param str 공백을 제거할 대상 문자열
// @return 공백이 제거된 문자열
//***************************************************************************
...
//***************************************************************************
// @brief SQL 쿼리 정보를 로그 파일에 기록합니다.
// @param dbClass 데이터베이스 종류 (EDBClass)
// @param title 로그 제목
// @param query 기록할 SQL 쿼리 문자열
// @param newline 줄바꿈 처리 여부
//***************************************************************************
