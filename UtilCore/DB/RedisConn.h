...
namespace RedisCpp
{
	...
	public:
		...
		// redis에 다시 연결
		//
		//	@return 재연결 성공 true, 재연결 실패 false.
		//***************************************************************************
		bool reconnect()
		{
			return (connect());
	...
	protected:
		//***************************************************************************
		// REDIS_REPLY_ARRY 유형의 reply->type 요소에서 데이터를 가져 와서 valueList 목록에 채운다.
		//
		...
		//***************************************************************************
		// REDIS_REPLY_ARRY 유형의 reply->type 요소에서 데이터를 가져 와서 valueMap 목록을 채운다.
		//
