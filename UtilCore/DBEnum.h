...
//***************************************************************************
//
inline const EIndexType StringToDBIndexType(const TCHAR* ptszIndexType)
{
...
//***************************************************************************
//
inline const EDataType StringToDBDataType(const TCHAR* ptszDataType, OUT uint64& maxLen)
{
