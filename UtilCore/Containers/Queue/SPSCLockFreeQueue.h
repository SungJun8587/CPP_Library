...
#ifndef __SPSCLOCKFREEQUEUE_H__
#define __SPSCLOCKFREEQUEUE_H__
...
private:
    ...
    alignas(LFQ_CACHE_LINE_SIZE) std::atomic<std::size_t> m_DequeuePos;    // 데이터가 추출될 다음 위치 (단일 컨슈머 전용, 캐시 라인 정렬)
