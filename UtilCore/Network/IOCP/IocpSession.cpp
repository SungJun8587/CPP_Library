...
// @details 기본 버퍼 크기(10240)로 수신 CRingBuffer를 초기화합니다.
//***************************************************************************
...
void CIocpSession::RegisterRecv()
{
    ...
    _recvEvent.Init();
    _recvEvent.owner = shared_from_this(); // I/O 완료 시까지 수명 보장 (Ref +1)
