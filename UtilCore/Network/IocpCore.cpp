...
//***************************************************************************
// @brief 배치 GQCSEx 방식으로 최대 BATCH_SIZE개의 완료 이벤트를 일괄 수거하여 처리합니다.
// @param timeoutMs 대기 시간 (밀리초)
// @return int32 실제 처리한 이벤트 개수
// @note
//     성능 근거:
...
// @note
//      기존 default: TODO → 에러 코드 분류 실제 구현
    ...
    DWORD numOfBytes, DWORD errorCode)
{
    ...
    CIocpObjectRef iocpObject = iocpEvent->owner;
