...
void* CQuantizer::CreateNode(uint32 nLevel, uint32	nColorBits, uint32* pLeafCount,
...
void CQuantizer::GetPaletteColors(NODE* pTree, RGBQUAD* prgb, uint32* pIndex, uint32* pSum)
{
	if( pTree )
	{
		if( pTree->bIsLeaf )
