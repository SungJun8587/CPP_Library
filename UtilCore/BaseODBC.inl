...
bool CBaseODBC::BindParamInput(int32 iParamIndex, _TMain& tValue, SQLLEN& lRetSize)
{
...
//	
template< typename _TMain >
bool CBaseODBC::BindParamOutput(int32 iParamIndex, _TMain& tValue, SQLLEN& lRetSize)
{
	CDBParamAttr& dbParam = m_DBParamAttrMgr(tValue);
...
//	
template< typename _TMain >
bool CBaseODBC::BindCol(int32 iParamIndex, _TMain& tValue, SQLLEN& lRetSize)
{
