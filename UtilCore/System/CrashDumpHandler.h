...
public:
    ...
    // =========================================================================
    // @brief  Windows Debug 빌드 환경에서 메모리 누수 감지 기능을 활성화합니다.
    // @detail 프로그램 종료 시 디버그 출력 창(Output Window)에 누수된 메모리
    //         블록의 파일명, 라인 수 및 덤프를 자동으로 출력합니다.
    // =========================================================================
    void enableMemoryLeakCheck();

    // =========================================================================
    // @brief  원하는 시점에 현재까지 쌓인 메모리 누수 상태를 정밀 덤프합니다.
    // =========================================================================
    void checkMemoryLeaksNow();
